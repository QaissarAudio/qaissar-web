...
export function StudioVoiceAdsSection() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="md:order-1">
            ...
            <p className="mt-6 text-[var(--text-body-lg)] font-semibold text-brand-black leading-snug">
              Natural AI voices — no studio, no announcer
            </p>

            <p className="mt-4 text-[var(--text-body)] font-light text-brand-gray-800 leading-relaxed">
              Write your message, pick a voice, and let Qaissar Sound generate a crisp,
              high-quality voice ad that drops straight into your broadcast. Perfect for
              promotions, announcements, and seasonal messages — instant, affordable, and ready
              to carry your brand&apos;s voice to your audience at any moment.
            </p>
          </div>
          ...
          <div className="flex justify-center md:order-2">
            <div className="relative inline-flex max-w-full">
              ...
              />
              <Image
                src="/images/app/web_qaiisar_section_4.png"
                width={900}
                height={600}
                alt="Qaissar Studio AI-powered voice ads"
...
export default StudioVoiceAdsSection
